    ...
    <div>
        <div>
            <nav class="navbar navbar-expand-lg navbar-light bg-white">
                <router-link to="/home"><img src="https://github.com/andrew-HuangHaoChe/image/blob/master/keyboardlogo.png?raw=true" class="logoImg"></router-link>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="navbar-nav ml-auto">
                    <li class="nav-item px-3">
                      <router-link :to="{ path: '/home'}" active-class="routerActive"><i class="fas fa-home fa-2x d-flex justify-content-center"></i><div class="d-flex justify-content-center homeFont">首頁</div></router-link>
                    </li>
                    <li class="nav-item px-3">
